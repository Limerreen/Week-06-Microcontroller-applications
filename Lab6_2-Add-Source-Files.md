...
**สังเกต:**
- การเพิ่มไฟล์ source ส่งผลต่อขนาด binary อย่างไร? : เมื่อเพิ่มไฟล์ source (.c) และเรียกใช้ฟังก์ชันภายใน ขนาด binary จะเพิ่มขึ้นตามโค้ดและข้อมูลที่ถูกเพิ่มเข้ามาในไฟล์นั้น
- LED กะพริบทุกกี่วินาที? : กะพริบทุกประมาณ 3 วินาที 
- แต่ละโมดูลแสดงข้อมูล file และ line อย่างไร? : ใช้มาโคร __FILE__ และ __LINE__ ในฟังก์ชัน ESP_LOGI เพื่อพิมพ์ชื่อไฟล์และหมายเลขบรรทัดที่สั่ง log ออกมา ทำให้ทราบว่าข้อความมาจากไฟล์และบรรทัดใด
